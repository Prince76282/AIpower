...
//           Upload your resume and job description to get ATS score and
...
const openai = new OpenAI({
  ...
  apiKey:
    "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",
  defaultHeaders: {
    ...
    <SafeAreaView style={styles.container} edges={["top", "left", "right"]}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <Text style={styles.analyzeButtonText}>
            {isAiLoading ? "AI Analyzing..." : "Analyze with AI"}
          </Text>
        </TouchableOpacity>
        ...
        {aiResponse && (
          <View style={styles.resultContainer}>
            <Text style={styles.improveTitle}>🤖 AI Suggestions:</Text>
